...
public class NotEqualBuilder implements ConditionBuilder {
    ...
    public <T> Predicate build(SearchFilter filter, CriteriaBuilder criteriaBuilder, Root<T> root,
        ...
        return criteriaBuilder.notEqual(path, builderHelper.convertValue(fieldType, fieldValue));
    }
    ...
    private Predicate getPredicateForDate(String fieldValue, CriteriaBuilder criteriaBuilder, Path<Object> path) {
        ...
        return criteriaBuilder.notEqual(path.as(Date.class), date);
    }
